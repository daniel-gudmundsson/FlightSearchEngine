...
/**
 * Controller class for everything concerning booking a flight
 *
 * @author dantg
 */
public class BookingController {
    ...
    /**
     * Resets all formally made booking actions, all tickets will be lost. Creates a new active booking and a
     * new booking number for that particular booking. Does not delete booking from the database.
     */
    ...
    /**
     * Save active booking to the database. If the booking was saved successfully, the active booking will be
     * reset and a new booking made (with a new booking number). Will return true if successful else false.
     *
     * @throws SQLException
     */
